...
class PokemonEntity(models.Model):
    ...
    appeared_at = models.DateTimeField(blank=True, verbose_name='Время появления на карте')
    disappeared_at = models.DateTimeField(blank=True, verbose_name='Время появления на карте')
